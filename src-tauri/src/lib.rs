...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            media_library::media_playlist_order_get,
            media_library::media_playlist_order_preview,
            media_library::media_playlist_order_save,
            media_library::media_playlist_clone,
            media_library::media_sort_rule_list,
            media_library::media_sort_rule_get,
            media_library::media_sort_rule_save,
            media_library::media_sort_rule_remove,
